...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', isLoading, disabled, children, ...props }, ref) => {
    ...
    const variantStyles = {
      primary: 'bg-gradient-primary text-white hover:shadow-lg hover:shadow-primary-purple/50 glow-hover',
      secondary: 'bg-transparent border-2 border-primary-purple text-text-primary hover:bg-primary-purple/10',
